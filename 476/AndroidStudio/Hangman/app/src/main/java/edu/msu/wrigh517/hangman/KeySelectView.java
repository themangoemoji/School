...
public class KeySelectView extends View {
    ...
    public KeySelectView(Context context) {
        super(context);
        init();
    }

    public KeySelectView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public KeySelectView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void touched(float x, float y) {
        ...
        if(x >= 0 && x < imageBitmap.getWidth() &&
            ...
            float keyWidth = (imageBitmap.getWidth() / 9);
            ...
            HangmanActivity activity = (HangmanActivity)getContext();
