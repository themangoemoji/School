...
/**
 * Class the communicates with the cloud for hattings
 */
public class Cloud {

    private static final String MAGIC = "NechAtHa6RuzeR8x";
    private static final String USER = "wrigh517";
    private static final String PASSWORD = "jaiz7310";
    private static final String CATALOG_URL = "https://webdev.cse.msu.edu/~wrigh517/cse476/step6/hatter-cat.php";
    private static final String SAVE_URL = "http://webdev.cse.msu.edu/~wrigh517/cse476/step6/hatter-save.php";
    ...
    //private static final String LOAD_URL = "https://webdev.cse.msu.edu/~wrigh517/cse476/step6/hatter-load.php";
    ...
    public static class CatalogAdapter extends BaseAdapter {
         ...
         * Constructor
         */
        public CatalogAdapter(final View view, final LoadDlg dlg) {
        ...
        public CatalogAdapter(final View view, final DeleteDlg dlg) {
            // Create a thread to load the catalog
            new Thread(new Runnable() {
